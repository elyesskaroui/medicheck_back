...
"describe this image of accident and try to give an explanation of the accident and estimate the damages you need to return a json format only json accepetd without any other things ",        {
          fileData: {
